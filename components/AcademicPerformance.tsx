...
function GaugeCard({ subject, points }: { subject: string; points: string }) {
  ...
  return (
    <div
      className="max-w-md overflow-hidden rounded-2xl bg-white shadow-sm
        dark:border-slate-700 dark:bg-slate-800"
    >
      {/* Card header */}
      <div
        className="flex items-center justify-between bg-sandpiper-blue px-5
          py-3"
      >
      ...
      <div className="px-5 pb-3 text-center">
        <div
          className="text-base font-extrabold tracking-wide text-sandpiper-blue
            dark:text-sandpiper-gold"
        >
          BLUE
        </div>
